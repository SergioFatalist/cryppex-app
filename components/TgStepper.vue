  ...
  <div class="h-6 text-sm relative select-none" :class="props.showNumber ? 'w-[100px]' : 'w-[80px]'">
    ...
    <div class="absolute inset-0 pr-2" @click="subtract()">
      <div
        ...
        :class="[props.subtractClass, props.value > 0 ? '' : 'inactive', props.showNumber ? 'w-1/3' : 'w-1/2']"
      >
    ...
    <!-- NUMBER WRAPPER -->
    <div v-if="props.showNumber" class="icon text-center w-1/3 font-medium" @click="subtract()">
      {{ props.value }}
    </div>
